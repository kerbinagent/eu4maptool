...
handleEvent (GS.EventKey (GS.SpecialKey GS.KeyUp) GS.Up _ _) (pmap, rmap, bsize , scr, vp, zoom) = return (pmap , rmap, bsize, scr,  moveView vp bsize scr zoom (100/zoom) Up, zoom)
handleEvent (GS.EventKey (GS.SpecialKey GS.KeyDown) GS.Up _ _) (pmap, rmap, bsize , scr, vp, zoom) = return (pmap , rmap, bsize, scr, moveView vp bsize scr zoom (100/zoom) Dn,  zoom)
handleEvent (GS.EventKey (GS.SpecialKey GS.KeyLeft) GS.Up _ _) (pmap, rmap, bsize , scr, vp, zoom) = return (pmap , rmap, bsize, scr, moveView vp bsize scr zoom (100/zoom) Lf, zoom)
handleEvent (GS.EventKey (GS.SpecialKey GS.KeyRight) GS.Up _ _) (pmap, rmap, bsize , scr, vp, zoom) = return (pmap , rmap, bsize, scr, moveView vp bsize scr zoom (100/zoom) Rg, zoom)
